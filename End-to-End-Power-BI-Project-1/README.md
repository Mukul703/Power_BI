...
- **Loan Amount by Purpose**
  Trend of loan distribution across different purposes.
- **Default Rate by Employment Type**
  Default rate variation by employment type over time.
- **Average Loan Amount by Age Group**
  Loan amount trends across age groups.
- **Average Income by Employment Type**
  Income trends for different employment types.
